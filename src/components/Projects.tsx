    ...
    <section id="projects" className="py-24 bg-[#050508] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 0.6 }}
          className="mt-16 relative overflow-hidden rounded-[20px] bg-[#07060c] border border-white/10 shadow-2xl flex flex-col sm:flex-row items-center justify-between min-h-[120px] gap-6 p-4 sm:p-0 group"
        >
